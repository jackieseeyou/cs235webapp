...
from games.domainmodel.model import User, Game, Review, Wishlist, Genre, Publisher

review_date = datetime.date(2023, 2, 28)
...
def insert_games(empty_session):
    empty_session.execute(
        'INSERT INTO games (game_id, game_title, price, release_date, description, image_url, website_url, video_url) VALUES '
